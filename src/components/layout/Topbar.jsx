...
export default function Topbar({ onQuickAdd }) {
  ...
  return (
    <header className="sticky top-0 z-30 h-16 bg-white/80 backdrop-blur-md border-b border-slate-200 flex items-center gap-4 px-6">
      ...
      <button
        onClick={onQuickAdd}
        className="flex items-center gap-2 px-4 py-2 bg-[hsl(var(--navy))] text-white rounded-lg text-sm font-medium hover:bg-[hsl(var(--navy-light))] transition-colors shadow-sm"
      >
