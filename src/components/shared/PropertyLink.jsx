...
export default function PropertyLink({ property, className = "", children }) {
  ...
  return (
    <Link
      ...
      className={`hover:underline decoration-[hsl(var(--sage))] decoration-2 underline-offset-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--ring))] rounded ${className}`}
    >
